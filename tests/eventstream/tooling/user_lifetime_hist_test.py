...
class TestEventstreamUserLifetimeHist:
    def test_user_lifetime_hist_eventstream__basic(self, test_stream: EventstreamType):
    ...
    def test_user_lifetime_hist_eventstream__timedelta_unit(self, test_stream: EventstreamType):
    ...
    def test_user_lifetime_hist_eventstream__lower_cutoff_quantile(self, test_stream: EventstreamType):
    ...
    def test_user_lifetime_hist_eventstream__upper_cutoff_quantile(self, test_stream: EventstreamType):
    ...
    def test_user_lifetime_hist_eventstream__upper_lower_cutoff_quantile(self, test_stream: EventstreamType):
