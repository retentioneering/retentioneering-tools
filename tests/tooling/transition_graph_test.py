...
from tests.tooling.fixtures.transition_graph import test_stream
...
class TestTransitionGraph:
    ...
    def test_transition_graph__nodes_weight_col_session(self, test_stream: EventstreamType) -> None:
        tg = TransitionGraph(eventstream=test_stream)
        tg.plot(nodes_weight_col="session_id")
    ...
    def test_transition_graph__edges_weight_col_session(self, test_stream: EventstreamType) -> None:
        tg = TransitionGraph(eventstream=test_stream)
        tg.plot(edges_weight_col="session_id")
    ...
    def test_transition_graph__settings(self, test_stream: EventstreamType) -> None:
        tg = TransitionGraph(eventstream=test_stream)
        tg.plot(
            show_percents=True,
