...
from .schema import RawDataCustomColSchema, RawDataSchema, EventstreamSchema
...
class EventstreamTest(unittest.TestCase):
  ...
  def test_index_events(self):
    raw_data = pd.DataFrame([
      { "name": "click_1", "event_timestamp": "2021-10-26 12:02", "user_id": "1", "type": "raw", },
      { "name": "pageview", "event_timestamp": "2021-10-26 12:00", "user_id": "1", "type": "raw", },
      { "name": "pause", "event_timestamp": "2021-10-26 12:03", "user_id": "1", "type": "pause", },
      { "name": "click_2", "event_timestamp": "2021-10-26 12:03", "user_id": "1", "type": "raw", },
      { "name": "end", "event_timestamp": "2021-10-26 12:03", "user_id": "1", "type": "end", },
      { "name": "start", "event_timestamp": "2021-10-26 12:03", "user_id": "1", "type": "start", },
    ])
  ...
  def test_join_eventstream(self):
    ...
    joined_df = pd.DataFrame([
      { "type": "synthetic", "name": "add_to_cart", "event_timestamp": "2021-10-26 12:02", "user_id": "1", "ref_id": source_events_df.iloc[1]["id"] },
      { "type": "synthetic", "name": "add_to_cart", "event_timestamp": "2021-10-26 12:04", "user_id": "1", "ref_id": source_events_df.iloc[3]["id"] },
      { "type": "synthetic", "name": "add_to_cart",  "event_timestamp": "2021-10-26 12:09", "user_id": "1", "ref_id": uuid.uuid4() },
      { "type": "synthetic", "name": "add_to_cart123",  "event_timestamp": "2021-10-26 12:10", "user_id": "2", "ref_id": None },
    ])
