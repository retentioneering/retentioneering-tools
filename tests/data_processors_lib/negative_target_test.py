...
from src.data_processors_lib.simple_processors import NegativeTargetParams, NegativeTarget
...
class TestNegativeTarget:
    ...
    def test_negative_target(self):
        ...
        params = {
            'negative_target_events': ['plus_icon_click'],
        }
        ...
        assert 'negative_target_plus_icon_click' in events_names
