...
class TestCutPathAfter:
    def test_cut_path_after_apply__by_one_event(self):
        ...
        events = CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=0, min_cjm=0))
    ...
    def test_cut_path_after_apply__by_two_events(self):
        ...
        events = CutPathAfterEvent(
            params=CutPathAfterEventParams(cutoff_events=["event3", "event2"], cut_shift=0, min_cjm=0)
        )
    ...
    def test_cut_path_after_apply__cut_shift(self):
        ...
        events = CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=2, min_cjm=0))
    ...
    def test_cut_path_after_apply__min_cjm_4(self):
        ...
        events = CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=0, min_cjm=4))
    ...
    def test_cut_path_after_apply__cut_shift_1_min_cjm_3(self):
        ...
        events = CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=1, min_cjm=3))
...
class TestCutPathAfterGraph:
    def test_cut_path_after_graph__by_one_event(self):
        ...
        events = EventsNode(
            CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=0, min_cjm=0))
        )
    ...
    def test_cut_path_after_graph__cut_shift_2(self):
        ...
        events = EventsNode(
            CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=2, min_cjm=0))
        )
        graph = PGraph(source_stream=source)
        graph.add_node(node=events, parents=[graph.root])
    ...
    def test_cut_path_after_graph__min_cjm_4(self):
        ...
        events = EventsNode(
            CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=0, min_cjm=4))
        )
        graph = PGraph(source_stream=source)
        graph.add_node(node=events, parents=[graph.root])
    ...
    def test_cut_path_after_graph__cut_shift_1_min_cjm_3(self):
        ...
        events = EventsNode(
            CutPathAfterEvent(params=CutPathAfterEventParams(cutoff_events=["event3"], cut_shift=1, min_cjm=3))
        )
        graph = PGraph(source_stream=source)
        graph.add_node(node=events, parents=[graph.root])
