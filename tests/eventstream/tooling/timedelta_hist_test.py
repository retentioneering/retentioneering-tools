...
class TestEventstreamTimedeltaHist:
    def test_timedelta_hist_eventstream__default(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__event_pair(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__adjacent_event_pairs(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__timedelta_unit(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__lower_quantile(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__upper_quantile(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__lower_upper_quantile(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__log_scale_x(self, source_stream_for_log_scale):
    ...
    def test_timedelta_hist_eventstream__agg(self, test_stream):
    ...
    def test_timedelta_hist_eventstream__es_start_path_end(self, source_stream_start_end_events):
    ...
    def test_timedelta_hist_eventstream__path_start_es_end(self, source_stream_start_end_events):
    ...
    def test_timedelta_hist_eventstream__path_end_es_end(self, source_stream_start_end_events):
    ...
    def test_timedelta_hist_eventstream__path_start_path_end(self, source_stream_start_end_events):
        correct_result = np.array([])
        correct_bins = np.array([])
        result = source_stream_start_end_events.timedelta_hist(
    ...
    def test_timedelta_hist_eventstream__sessions(self, source_stream_sessions):
