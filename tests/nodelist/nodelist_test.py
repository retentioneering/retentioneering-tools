...
class TestNodelist:
    def test_edgelist__simple(self, test_df: pd.DataFrame, nl_simple_corr: pd.DataFrame) -> bool:
    ...
    def test_nodelist__user(self, test_df: pd.DataFrame, nl_user_corr: pd.DataFrame) -> bool:
    ...
    def test_nodelist__sessions(self, test_df: pd.DataFrame, nl_session_corr: pd.DataFrame) -> bool:
