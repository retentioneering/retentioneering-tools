...
class EventstreamTest(unittest.TestCase):
    ...
    def test_get_prepared_custom_col(self):
        ...
        raw_data_schema.custom_cols = [
            {"custom_col": col, "raw_data_col": col} for col in custom_cols
        ]
    ...
    def test_index_events(self):
        raw_data = pd.DataFrame([
            {"name": "click_1", "event_timestamp": "2021-10-26 12:02",
                "user_id": "1", "type": "raw", },
            {"name": "pageview", "event_timestamp": "2021-10-26 12:00",
             "user_id": "1", "type": "raw", },
            {"name": "pause", "event_timestamp": "2021-10-26 12:03",
             "user_id": "1", "type": "pause", },
            {"name": "click_2", "event_timestamp": "2021-10-26 12:03",
             "user_id": "1", "type": "raw", },
            {"name": "end", "event_timestamp": "2021-10-26 12:03",
             "user_id": "1", "type": "end", },
            {"name": "start", "event_timestamp": "2021-10-26 12:03",
             "user_id": "1", "type": "start", },
        ])
        ...
        self.assertListEqual(
            names,
            ["pageview", "click_1", "start", "click_2", "pause", "end"]
        )
    ...
    def test_create_relation(self):
        ...
        for [i, event] in related_df.iterrows():
            ...
            self.assertEqual(
                related_event[es.schema.event_id],
                event["ref_0"]
            )
            ...
            self.assertEqual(
                related_event[es.schema.user_id],
                event[related_es.schema.user_id]
            )
    ...
    def test_join_eventstream(self):
        ...
        source_df = pd.DataFrame([
            ...
            {"event_name": "plus_icon_click",
                "event_timestamp": "2021-10-26 12:04", "user_id": "1"},
        ])
        ...
        joined_df = pd.DataFrame([
            {"type": "synthetic", "name": "add_to_cart", "event_timestamp": "2021-10-26 12:02",
                "user_id": "1", "ref_id": source_events_df.iloc[1]["id"]},
            {"type": "synthetic", "name": "add_to_cart", "event_timestamp": "2021-10-26 12:04",
                "user_id": "1", "ref_id": source_events_df.iloc[3]["id"]},
            {"type": "synthetic", "name": "add_to_cart",
                "event_timestamp": "2021-10-26 12:09", "user_id": "1", "ref_id": uuid.uuid4()},
            {"type": "synthetic", "name": "add_to_cart123",
                "event_timestamp": "2021-10-26 12:10", "user_id": "2", "ref_id": None},
        ])
        ...
        child = Eventstream(
            ...
            relations=[
                {"evenstream": source, "raw_col": "ref_id"}
            ]
        )
        ...
        self.assertEqual(deleted_events_names, [
            "cart_btn_click",
            "plus_icon_click"
        ])
    ...
    def test_soft_delete(self):
        ...
        source.soft_delete(
            events=df[df[source.schema.event_name] == "pageview"])
        ...
        self.assertEqual(with_deleted_event_names, [
            "pageview",
            "click_1",
            "click_2"
        ])
        ...
        source.soft_delete(
            events=after_delete[after_delete[source.schema.event_name] == "click_1"]
        )
    ...
    def test_delete_events_by_join(self):
        ...
        related_df = related_df[(related_df["name"] == "pageview") | (
            related_df["name"] == "click_1")]
