...
def _system_instructions(
    ...
    lines += [
        ...
        "This is a strict, ordered funnel: each level is named after the DEEPEST",
        "funnel event completed in order — skipping or reordering an earlier step",
        "keeps a path from being credited for a later one it reached.",
