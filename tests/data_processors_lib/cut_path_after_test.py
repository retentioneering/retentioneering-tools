...
from src.data_processors_lib.simple_processors import CutPathAfterEvent, CutPathAfterEventParams
...
class TestCutPathAfter:
    ...
    def test_cut_path_after(self):
        ...
        events = CutPathAfterEvent(params=CutPathAfterEventParams(**params))
