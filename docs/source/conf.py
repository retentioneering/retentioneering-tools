...
latex_documents = [
    (master_doc, 'RetentioneeringTools.tex', 'Retentioneering Tools Documentation',
     'Retentioneering User Trajectory Analysis Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'retentioneeringtools', 'Retentioneering Tools Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RetentioneeringTools', 'Retentioneering Tools Documentation',
     author, 'RetentioneeringTools', 'One line description of project.',
     'Miscellaneous'),
]
